...
public class CemtnTestContainer extends TestContainer {

    public CemtnTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/rtcab/cemtn/app.properties",
    ...
    public static class Common extends CemtnTestContainer {

        public static final CemtnTestContainer.Common INSTANCE = new CemtnTestContainer.Common();
